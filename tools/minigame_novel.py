...
class MechanicInventor:
    ...
    Works in two modes:
      ...
      2. LLM-assisted — richer, more creative (when API key available)
    """

    def __init__(self, use_llm: bool = False, llm_callback=None):
